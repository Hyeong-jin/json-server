...
describe('Server', () => {
  ...
  describe('GET /:resource', () => {
    test('should respond with json and corresponding resources', () =>
      request(server)
        ...
        .expect(200, { resultCode: 'S', data: db.posts }));

    test('should respond with 404 if resource is not found', () =>
      request(server).get('/undefined').expect(200));
  });
  ...
  describe('GET /:resource?attr=&attr=', () => {
    test('should respond with json and filter resources', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: [db.comments[0]] }));

    test('should be strict', () =>
      request(server)
        .get('/users?tel=123')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: [db.users[1]] }));
    ...
    test('should support multiple filters', () =>
      request(server)
        ...
        .expect(200, {
          resultCode: 'S',
          data: [db.comments[0], db.comments[1]],
        }));
    ...
    test('should support deep filter', () =>
      request(server)
        .get('/deep?a.b=1')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: [db.deep[0]] }));
    ...
    test('should ignore unknown query parameters', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.comments }));
    ...
    test('should not fail with null value', () => {
      ...
      return request(server)
        .get('/posts?body=foo')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: [db.posts[0]] });
    });
  });
  ...
  describe('GET /:resource?q=', () => {
    test('should respond with json and make a full-text search', () =>
      request(server)
        .get('/tags?q=pho')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: [db.tags[1], db.tags[2]] }));
    ...
    test('should support filtering by boolean value false', () =>
      request(server)
        ...
        .expect(200, {
          resultCode: 'S',
          data: [db.comments[1], db.comments[2], db.comments[4]],
        }));
  });
  ...
  describe('GET /:resource?_end=', () => {
    test('should respond with a sliced array', () =>
      request(server)
        ...
        .expect(200, { resultCode: 'S', data: db.comments.slice(0, 2) }));
  });
  ...
  describe('GET /:resource?_sort=', () => {
    test('should respond with json and sort on a field', () =>
      request(server)
        ...
        .expect(200, {
          resultCode: 'S',
          data: [db.tags[1], db.tags[0], db.tags[2]],
        }));
    ...
    test('should reverse sorting with _order=DESC', () =>
      request(server)
        ...
        .expect(200, {
          resultCode: 'S',
          data: [db.tags[2], db.tags[0], db.tags[1]],
        }));
    ...
    test('should sort on numerical field', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.posts.reverse() }));
    ...
    test('should sort on nested field', () =>
      request(server)
        ...
        .expect(200, {
          resultCode: 'S',
          data: [db.nested[1], db.nested[0], db.nested[2]],
        }));
  ...
  describe('GET /:resource?_start=&_end=', () => {
    test('should respond with a sliced array', () =>
      request(server)
        ...
        .expect('X-Total-Count', db.comments.length.toString())
        .expect('Access-Control-Expose-Headers', 'X-Total-Count')
        .expect(200, { resultCode: 'S', data: db.comments.slice(1, 2) }));
  });
  ...
  describe('GET /:resource?_page=', () => {
    test('should paginate', () =>
      request(server)
        ...
        .expect(200, { resultCode: 'S', data: db.list.slice(10, 20) }));
  });
  ...
  describe('GET /:resource?_page=&_limit=', () => {
    test('should paginate with a custom limit', () => {
      ...
      return request(server)
        ...
        .expect('link', link)
        .expect('Access-Control-Expose-Headers', 'X-Total-Count, Link')
        .expect(200, { resultCode: 'S', data: db.list.slice(1, 2) });
    });
  });
  ...
  describe('GET /:resource?attr_gte=&attr_lte=', () => {
    test('should respond with a limited array', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.comments.slice(1, 3) }));
  });
  ...
  describe('GET /:resource?attr_ne=', () => {
    test('should respond with a limited array', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.comments.slice(1) }));

    test('should accept multiple parameters', () =>
      request(server)
        .get('/comments?id_ne=1&id_ne=2')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.comments.slice(2) }));
  });
  ...
  describe('GET /:resource?attr_like=', () => {
    ...
    test('should accept multiple parameters', () =>
      request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.tags }));
  });
  ...
  describe('GET /:resource/:id', () => {
    ...
    test('should support string id, respond with json and corresponding resource', () =>
      request(server)
        .get('/refs/abcd-1234')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.refs[0] }));

    test('should support integer id as string', () =>
      request(server)
        .get('/stringIds/1234')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: db.stringIds[0] }));
  ...
  describe('GET /:resource?_embed=', () => {
    test('should respond with corresponding resources and embedded resources', () => {
      ...
      return request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: posts });
    });
  });
  ...
  describe('GET /:resource/:id?_embed=', () => {
    test('should respond with corresponding resources and embedded resources', () => {
      ...
      return request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: post });
    });
  });
  ...
  describe('GET /:resource?_expand=', () => {
    test('should respond with corresponding resource and expanded inner resources', () => {
      ...
      return request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: refs });
    });
  });
  ...
  describe('GET /:resource/:id?_expand=', () => {
    test('should respond with corresponding resource and expanded inner resources', () => {
      ...
      return request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: comment });
    });
  });
  ...
  describe('GET /:resource/:id?_expand=&_expand=', () => {
    test('should respond with corresponding resource and expanded inner resources', () => {
      ...
      return request(server)
        ...
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: comments });
    });
  });
  ...
  describe('PUT /:resource/:id', () => {
    test('should respond with json and replace resource', async () => {
      ...
      assert.deepStrictEqual(db.posts[0], {
        resultCode: 'S',
        data: post,
      });
    });
  ...
  describe('DELETE /:resource/:id', () => {
    test('should respond with empty data, destroy resource and dependent resources', async () => {
      await request(server).del('/posts/1').expect(200, { resultCode: 'S' });
  ...
  describe('Rewriter', () => {
    test('should rewrite using prefix', () =>
      request(server)
        .get('/api/posts/1')
        .expect({ resultCode: 'S', data: db.posts[0] }));
    ...
    test('should rewrite using query without params', () => {
      ...
      return request(server)
        ...
        .expect({ resultCode: 'S', data: expectedPost });
    });

    test('should rewrite using params and query', () =>
      request(server)
        .get('/comments/special/1-quux')
        .expect(200, { resultCode: 'S', data: [db.comments[4]] }));
  ...
  describe('router.render', () => {
    beforeEach(() => {
      router.render = (req, res) => {
        res.jsonp({ resultCode: 'S', data: res.locals.data });
      };
    });
  ...
  describe('router.db._.id', () => {
    ...
    test('should be possible to GET using a different id property', () =>
      request(server)
        .get('/posts/1')
        .expect('Content-Type', /json/)
        .expect(200, { resultCode: 'S', data: router.db.getState().posts[0] }));
    ...
    test('should be possible to POST using a different id property', () =>
      request(server)
        ...
        .send({ body: 'hello' })
        .expect('Content-Type', /json/)
        .expect(201, { resultCode: 'S', data: { _id: 2, body: 'hello' } }));
  });
});
